...
class YOLOMultiTaskPlatformView(
    ...
    init {
        ...
        eventChannel = EventChannel(messenger, "com.aicycle.yolo/multiTaskResults_$idStr")
        ...
        methodChannel = MethodChannel(messenger, "com.aicycle.yolo/multiTaskControl_$idStr")
