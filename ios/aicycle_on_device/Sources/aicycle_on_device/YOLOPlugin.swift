...
public final class YOLOPlugin: NSObject, @preconcurrency FlutterPlugin, @unchecked Sendable {
  ...
  public static func register(with registrar: FlutterPluginRegistrar) {
    ...
    registrar.register(factory, withId: "com.aicycle.yolo/YOLOPlatformView")
    ...
    registrar.register(multiTaskFactory, withId: "com.aicycle.yolo/YOLOMultiTaskPlatformView")
